...
BEGIN
    ...
    -- Tournaments
    INSERT INTO tournaments (name, game, max_players, status, utc_start_timestamp, utc_created_at)
    VALUES
    ...
    INSERT INTO matches (tournament_id, player1_id, player2_id, winner_id, utc_match_timestamp)
    VALUES
